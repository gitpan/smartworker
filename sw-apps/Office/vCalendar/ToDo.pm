...
#------------------------------------------------------------
#  CVS ID tag...
# $Id: ToDo.pm,v 1.1 1999/09/02 19:53:55 gozer Exp $
#------------------------------------------------------------
...
#@ISA = qw(Office::vCalendar Parse::vCalendar::Component AutoLoader);
@ISA = qw(Office::vCalendar::Component AutoLoader);

$VERSION = '0.01';


#print Office::vCalendar::Component->start_tag('TODO');
#print $self->SUPER::end_tag('TODO');
...
Office::vCalendar::ToDo - one line description of the module 
