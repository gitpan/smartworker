...
package SW::GUIElement::Text;

#------------------------------------------------------------
# SW::GUIElement::Text
# Basic text element: standard HTML text
#------------------------------------------------------------
# $Id: Text.pm,v 1.10 1999/11/15 18:17:33 gozer Exp $
#------------------------------------------------------------
...
sub new
{
	...
	$self->{renderCallback} = "renderText";
 
	if (! $self->{hc})
	{
		$self->{params}->{text} = shift;
		$self->{params}->{bgColor} = shift;
		$self->{params}->{textColor} = shift;
	}
...
SW::GUIElement::Text - swText   generic text UI component
