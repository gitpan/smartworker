...
package SW::GUIElement::ImageRollover;

#------------------------------------------------------------
# SW::GUIElement::ImageRollover
# Image that changes whenever the mouse cursor is over it
#------------------------------------------------------------
# $Id: ImageRollover.pm,v 1.7 1999/11/15 18:17:33 gozer Exp $
#------------------------------------------------------------
...
sub new
{
	...
	$self->{renderCallback} = "renderImageRollover";
